...
import { OpenClawGateway } from "./openclaw-gateway.js";

async function main() {
  try {
    // 创建网关
    const gateway = new OpenClawGateway("./workspace");
...
async function startInteractiveSession(gateway: OpenClawGateway): Promise<void> {
