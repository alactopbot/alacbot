 ...
 */
export class OpenClawGatewayEnhanced {
  private workspaceManager: WorkspaceManager;
  private agentLoader: ExtendedAgentLoader;
  ...
  constructor(
    ...
    this.agentLoader = new ExtendedAgentLoader(
  ...
  async init(): Promise<void> {
    console.log("🚀 Initializing Enhanced OpenClaw Gateway...\n");
  ...
  displayWelcome(): void {
    ...
    console.log("🦞 Enhanced OpenClaw Gateway");
    console.log("=".repeat(60));
    console.log("\n💡 Tips:");
