...
export class AlacBotGatewayFinal {
    constructor(workspaceDir = "./workspace", userId = "user1") {
        ...
        this.agentLoader = new ExtendedAgentLoaderV2(this.workspaceManager, this.skillsManager, this.modelManager);
        this.commandHandler = new CommandHandlerEnhanced(this.sessionStore, this.skillsManager, this.workspaceManager, this.modelManager, userId);
    ...
    displayWelcome() {
        ...
        console.log(`  ${modelInfo.modelName} (${modelInfo.provider}/${modelInfo.modelId})\n`);
    }
    /**
     * 显示模型信息
     */
